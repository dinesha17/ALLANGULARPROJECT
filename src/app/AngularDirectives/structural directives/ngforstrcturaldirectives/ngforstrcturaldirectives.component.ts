...
@Component({
  selector: 'app-ngforstrcturaldirectives',
  templateUrl: './ngforstrcturaldirectives.component.html',
  styleUrls: ['./ngforstrcturaldirectives.component.css']
})
export class NgforstrcturaldirectivesComponent {
  title:string='';
  ...
  trackByFn(index: any, item: { name: any; }) {
    return item.name;
  }
}
